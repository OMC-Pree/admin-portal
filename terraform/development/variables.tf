variable "domain_name" {
  ...
  default = "admin-portal-dev-85a3-uk.techomc.com"
}

variable "s3_bucket_origin" {
  default = "s3://admin-portal-dev-uk.techomc.com"
}

variable "certificate_arn" {
  type = string
  description = "ARN of the dev certificate"
...
variable "bucket_name" {
  ...
  default = "admin-portal-dev-uk.techomc.com"
}
